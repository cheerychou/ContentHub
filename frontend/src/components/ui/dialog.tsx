...
/**
 * 对话框组件（自 CDD3 platform-web/ui 移植，2026-09-10，MIT）
 * Base UI 适配：Overlay→Backdrop、Content→Popup、data-[state=open/closed]→data-open/closed
 */
...
// Base UI：Overlay→Backdrop、Content→Popup、data-[state=open/closed]→data-open/closed
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border bg-background p-6 shadow-lg duration-normal outline-none data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 sm:max-w-lg",
          className
        )}
        {...props}
      >
